...
namespace GameApp.Domain.Entities.Game
{
      public class GameEntity
      {
            ...
            public GameEntity(string name, DateOnly published, List<string> platforms, List<string> genders, GamePhotoEntity? coverPhoto = null)
            {
                  Name = name;
                  Published = published;
                  Platforms = platforms;
            ...
            public void SetCoverPhoto(GamePhotoEntity photo)
            {
                  CoverPhoto = photo;
            }
            ...
            public GamePhotoEntity? CoverPhoto { get; private set; }
